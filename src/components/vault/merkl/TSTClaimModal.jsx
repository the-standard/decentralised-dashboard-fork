...
const TSTClaimModal = (props) => {
  ...
  const { writeContract: writeContractClaim, isError: isErrorClaim, isPending: isPendingClaim, isSuccess: isSuccessClaim, error: errorClaim } = useWriteContract();
